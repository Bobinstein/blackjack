...
function ant.init()
	...
	-- spec modules
	local balances = require("antSpec.balances")
	local initialize = require("antSpec.initialize")
	local records = require("antSpec.records")
	local controllers = require("antSpec.controllers")
	...
	Ticker = Ticker or "AOBJ"
	Logo = Logo or "NTvs7R4TQtIAtHsUM7Pn59SjH5NtlbO7F1tivzgKmyU"
